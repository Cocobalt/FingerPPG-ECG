    ...
    void action() {
        ...
        if (mode == Values.MODE_VIDEO) {
            if (isRecordingVideo) {
                ...
                HeartRate.measurePulse(cameraTextureView, this);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            if (isRecordingVideo) {
                //write csv
                try {
                    String accCsvFileName = nameAgeGenderExp + "_ACCELEROMETER.csv";
            ...
            String gyroCsvFileName = nameAgeGenderExp + "_GYRO.csv";
            if (isRecordingVideo) {
                try {
            ...
            String magnetCsvFileName = nameAgeGenderExp + "_MAGNET.csv";
            if (isRecordingVideo) {
                try {
            ...
            String lightCsvFileName = nameAgeGenderExp + "_LIGHT.csv";
            if (isRecordingVideo) {
                try {
                    ...
                    CameraCaptureSession.StateCallback stateCallback = new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession session) {
                            ...
                            try {
                                ...
                                previewCaptureRequestBuilder.set(CaptureRequest.CONTROL_MODE, CaptureRequest.CONTROL_MODE_AUTO);
