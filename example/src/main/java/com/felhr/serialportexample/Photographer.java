...
public interface Photographer {
    ...
    void updatePreview(Runnable exceptionCallback);

    void updatePreview2(Runnable exceptionCallback);

//    void setColorCorrectionGains(RggbChannelVector rgbVector);
//
//    void setColorCorrectionGains2(RggbChannelVector rgbVector);
    ...
    void startRecording2(@Nullable MediaRecorderConfigurator configurator);
    /**
    ...
    void setOnEventListener2(OnEventListener listener);
