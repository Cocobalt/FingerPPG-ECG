...
public class Utils {
    ...
    public static String getVideoFilePath(String name) throws IOException {
        return getFilePath(name + ".mp4");
    }
...
//            }
//        }
//        return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Record/" + fileSuffix;
        return Camera2Photographer.getFilePath() + fileSuffix;
    }
    ...
    static int getDisplayOrientation(AppCompatActivity activity, int sensorOrientation) {
